...
def main():
    ...
    predict_results = dt.predict(test_feature)
    dump(dt, f"{args.output_folder}/model.joblib")
    ...
    result_data = ["De_Tree", train_accuracy, test_accuracy] + [acc for acc in cls_result]
